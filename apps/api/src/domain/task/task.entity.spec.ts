...
describe('Task', () => {
  it('should throw when name is empty', () => {
    expect(() => new Task('task-1', 'workspace-1', null, null, '')).toThrow(
  ...
  it('should throw when name contains only spaces', () => {
    expect(
      () => new Task('task-1', 'workspace-1', 'project-1', null, '          '),
    ).toThrow('Task name cannot be empty.');
  });

  it('should create a task with a valid name', () => {
    const task = new Task('task-1', 'workspace-1', 'project-1', null, 'Task 1');
  ...
  it('should create a task without a project', () => {
    const task = new Task('task-1', 'workspace-1', null, null, 'Task 1');
  ...
  it('should unassign the Task', () => {
    const task = new Task('task-1', 'workspace-1', null, 'user-1', 'Task 1');
